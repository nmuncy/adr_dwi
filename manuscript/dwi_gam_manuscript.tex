...
% Findings - time, scalar change and recovery time
[TBD - transition to temporal dynamics of injury]
...
% TODO: Limitations: Interpretation of statistic (flatness and LGI, LGIO models), all data in one model - underfit certain profiles, scan-rescan variance in addition to algorithmic, heterogeneity of injury and insufficient sample size to cluster symptom profiles, tensor products can be driven by sparesely sampling.

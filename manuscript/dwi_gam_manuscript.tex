...
\begin{equ}[H]
	...
	\end{lstlisting}
	\caption{Tract scalars are modeled as a function of tract node with thin-plate regression splines using both global and group smooths, individual wiggliness terms for groups, and ordered factors to compare Post and RTP group smooths to Base.}
...
\begin{equ}[H]
	...
	\end{lstlisting}
	\caption{Tract scalars are modeled as a function of separate 2D node and ImPACT smooths as well as a 3D tensor product interaction surface, with ordered factors used to compare Post and RTP surfaces to Base.}

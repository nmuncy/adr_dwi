...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[scale=0.425]{fig_hypotheses.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[scale=0.11]{fig_LGIO_callosal_smooths.png}}
